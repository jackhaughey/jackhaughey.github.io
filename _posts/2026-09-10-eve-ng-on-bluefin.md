...
Accessing EVE‑NG from an immutable Linux like Bluefin (a Fedora Silverblue spin) is a fantastic setup for network labs, but there’s one snag many people hit immediately:
...
This script is the bridge between GNOME and your container.
...
You should now see Ptyxis open inside your distrobox container with a working telnet session.

If you click a device in EVE‑NG, a terminal will open connected to the relevant device.
...
This is the most seamless, native-feeling way to integrate EVE‑NG with Bluefin Linux.
